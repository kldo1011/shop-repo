...
public class ArtikelResource {
	...
	public Response findAllArtikel() {
		...
		return Response.ok(new GenericEntity<List<?extends AbstractArtikel>>(artikelList) {}).build();
	...
	public Response findArtikelById(@PathParam("id")long id) {
		...
		if(artikel == null)
			throw new NotFoundException("Es Wurden keine Artikel mit der "+id+ "geunden");
